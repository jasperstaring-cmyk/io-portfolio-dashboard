    ...
    <div style={s.wrap}>
      ...
      <div style={s.donutCol}>
        ...
        <div style={s.donutSvgWrap}>
          <svg key={showComparison ? 'comp' : 'base'} viewBox="0 0 260 260" preserveAspectRatio="xMidYMid meet" style={{ ...s.donutSvg, opacity: animated ? 1 : 0, transform: animated ? 'scale(1)' : 'scale(0.92)', transition: 'opacity 0.5s ease, transform 0.55s cubic-bezier(0.34,1.26,0.64,1)', transformOrigin: 'center' }}>
